              ...
              <div className="flex items-center text-sm">
                <div className="h-8 w-8 rounded-full flex items-center justify-center bg-gaming-card-bg mr-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <polyline points="10 2 10 11 13 7 16 11 16 2"></polyline>
                  </svg>
                </div>
                <span className="font-medium">{profile.blogs}</span>
                <span className="text-gaming-text-secondary ml-1">блогов</span>
              </div>
